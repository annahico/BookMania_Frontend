        ...
        <div className="space-y-4">
          {paginated.map((loan) => (
            <div key={loan.id}
              ...
              <div>
                <h3 className="font-semibold text-pink-700">{loan.bookTitle}</h3>
                ...
                <div className="flex gap-2">
                  {loan.status === "ISSUED" && loan.extensionsUsed < 3 && (
                    <button onClick={() => handleExtend(loan.id)}
                      className="text-sm border border-pink-400 text-pink-700 hover:bg-pink-50 px-4 py-2 rounded-xl transition-colors">
                      Prorrogar
                    </button>
                  )}
                  <button onClick={() => handleReturn(loan.id)}
                    className="text-sm bg-pink-700 hover:bg-pink-800 text-white px-4 py-2 rounded-xl transition-colors">
                    Devolver
                  </button>
                </div>
              )}
